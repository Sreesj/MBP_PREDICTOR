...
Microtubule-Binding Proteins (MBPs) play a critical role in stabilizing and regulating microtubule dynamics, influencing key cellular processes such as division, transport, and signaling. This project â€” MBP_PREDICTOR â€” presents a machine learningâ€“based approach for the classification of MBPs and non-MBPs using protein sequenceâ€“derived features. The model integrates physicochemical descriptors such as amino acid composition, charge distribution, hydrophobicity, isoelectric point, and motif presence, along with advanced embedding-based representations from protein language models.
